...
subtitle: "GMBA Case Study Report (2023)"
date: "June 2026"
format:
  pdf:
...
This case study addresses three high-order management questions through the lens of **Netflix's** netflix password sharing crackdown. The issue is not only a famous business story; it is a decision problem about how leaders use evidence, protect stakeholders, and act when strategy, incentives, and public trust collide.

1. **Strategy & Value Creation**
   - How can data-driven decision-making create sustainable competitive advantage?
   - *Case Application*: Netflix needed to interpret market, operational, financial, and stakeholder signals before choosing whether to defend the existing model or make a more fundamental change.
...
**Debate Proposition**: "Is it ethical to change rules on existing customers, and did Netflix time it correctly?"
...
Netflix reversed years of tolerated password sharing and converted unpaid account use into paid subscriptions despite customer resistance. The surrounding industry environment made the decision more difficult because competitors, customers, investors, and regulators were already changing expectations about speed, transparency, and value creation.
...
The core business problem is how Netflix should respond when evidence suggests that the current approach is producing strategic, ethical, or operational risk. The case connects directly to Subscription economics, customer lifetime value, policy enforcement timing, but the management dilemma is broader: leaders must decide whether the problem is a temporary execution failure or a sign that the underlying model needs redesign.
...
\toprule
\rowcolor{lightgray}
\textbf{Technique} & \textbf{Application at Netflix} \\
\midrule
\endhead
...
- Subscription economics, customer lifetime value, policy enforcement timing provides a theoretical basis for analyzing the decision.
...
- Netflix, Inc. (2023). *Quarterly earnings materials*. <https://ir.netflix.net/financials/quarterly-earnings/default.aspx>
  - Relevance: Provides official subscriber and financial reporting around the password-sharing crackdown.

- Netflix. (2023). *An update on sharing*. <https://about.netflix.com/en/news/an-update-on-sharing>
  - Relevance: Documents Netflix's public explanation for restricting account sharing.
